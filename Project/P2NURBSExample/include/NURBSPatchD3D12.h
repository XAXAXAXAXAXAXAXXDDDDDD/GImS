...
public:
  ...
  NURBSPatchD3D12();
  NURBSPatchD3D12(const NURBSPatchD3D12& other)                  = default;
  NURBSPatchD3D12(NURBSPatchD3D12&& other) noexcept              = default;
  NURBSPatchD3D12& operator=(const NURBSPatchD3D12& other)       = default;
  NURBSPatchD3D12& operator=(NURBSPatchD3D12&& other) noexcept   = default;
