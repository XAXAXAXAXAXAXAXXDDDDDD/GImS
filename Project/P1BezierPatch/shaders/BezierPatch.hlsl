...
VS_CONTROL_POINT_OUTPUT VS_main(VS_CONTROL_POINT_INPUT Input)
{
...
HS_OUTPUT HS_main(InputPatch<VS_CONTROL_POINT_OUTPUT, INPUT_PATCH_SIZE> p,
...
//--------------------------------------------------------------------------------------
float4 PS_main_Wireframe(DS_OUTPUT Input) : SV_TARGET
{
