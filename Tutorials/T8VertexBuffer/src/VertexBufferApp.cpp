...
private:
  ...
  void createPipeline()
  {
    m_triangleMeshProgram =
        HLSLProgram(L"../../../Tutorials/T8VertexBuffer/Shaders/VertexBuffer.hlsl", "VS_main", "PS_main");
  ...
  void createTriangleMesh()
  {
    ...
    getDevice()->CreateCommittedResource(&defaultHeapProperties, D3D12_HEAP_FLAG_NONE, &vertexBufferDesc,
                                         D3D12_RESOURCE_STATE_COPY_DEST, nullptr, IID_PPV_ARGS(&m_vertexBufferGPU));
...
int main(int /* argc*/, char /* **argv */)
{
  ...
  config.title    = L"Tutorial 8 Vertex Buffer";
